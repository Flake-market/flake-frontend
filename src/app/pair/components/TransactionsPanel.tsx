...
// Replace the empty transactions array with:
const transactions: Transaction[] = transactionData.filter(
  tx => tx.contractAddress === "0xf1fdc83c3a336bdbdc9fb06e318b08eaddc82ff4" // You'll want to make this dynamic based on the current market's contract address
)
